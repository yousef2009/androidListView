...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.add(new Country(1, R.drawable.ic_afghanistan, "Afghanistan",
                "Population: 25,500,100", "Area: 652,090 km2"));
        data.add(new Country(1, R.drawable.ic_india, "India",
                "Population: 1,241,610,000", "Area: 3,387,260 km2"));
        data.add(new Country(1, R.drawable.ic_iran, "Iran",
                "Population: 77,288,000", "Area: 1,648,200 km2"));
        data.add(new Country(1, R.drawable.ic_china, "China",
                "Population: 1,363,350,000", "Area: 9,640,820 km2"));
        data.add(new Country(1, R.drawable.ic_america, "United State",
